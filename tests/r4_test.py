...
def test_return_book_valid_input():
    ...
    # 1984 ISBN
    success, message = return_book_by_patron("123456", "9780451524935")
...
def test_return_book_invalid_isbn_too_long():
    ...
    success, message = return_book_by_patron("123456", "12345678901234")
...
def test_return_book_invalid_isbn_too_short():
    ...
    success, message = return_book_by_patron("123456", "123456789012")
...
def test_return_book_invalid_isbn_with_letters():
    ...
    success, message = return_book_by_patron("123456", "1234567890LOL")
...
def test_return_book_invalid_patron_too_long():
    ...
    success, message = return_book_by_patron("1234567", "9780451524935")
...
def test_return_book_invalid_patron_too_short():
    ...
    success, message = return_book_by_patron("12345", "9780451524935")
...
def test_return_book_invalid_patron_with_letters():
    ...
    success, message = return_book_by_patron("12345X", "9780451524935")
...
def test_return_book_invalid_incorrect_patron():
    ...
    # 1984 ISBN
    success, message = return_book_by_patron("000001", "9780451524935 ")
