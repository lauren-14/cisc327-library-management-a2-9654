...
def test_late_fee_valid_input_14_or_less():
    ...
    # 1984 ISBN
    values, message = library_service.calculate_late_fee_for_book("123456", "9780451524935")
...
def test_late_fee_invalid_isbn_too_long():
    ...
    success, message = library_service.calculate_late_fee_for_book("123456", "12345678901234")
...
def test_late_fee_invalid_isbn_too_short():
    ...
    success, message = library_service.calculate_late_fee_for_book("123456", "123456789012")
...
def test_late_fee_invalid_isbn_with_letters():
    ...
    success, message = library_service.calculate_late_fee_for_book("123456", "1234567890LOL")
...
def test_late_fee_invalid_isbn_not_in_db():
    ...
    success, message = library_service.calculate_late_fee_for_book("123456", "1234567890123")
...
def test_late_fee_invalid_patron_too_long():
    ...
    success, message = library_service.calculate_late_fee_for_book("1234567", "9780451524935")
...
def test_late_fee_invalid_patron_too_short():
    ...
    success, message = library_service.calculate_late_fee_for_book("12345", "9780451524935")
...
def test_late_fee_invalid_patron_with_letters():
    ...
    success, message = library_service.calculate_late_fee_for_book("12345X", "9780451524935")
...
def test_late_fee_invalid_incorrect_patron():
    ...
    # 1984 ISBN
    success, message = library_service.calculate_late_fee_for_book("000001", "9780451524935 ")
